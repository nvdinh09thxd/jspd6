...
<link href="<%=request.getContextPath()%>/activetin/style.css"
	rel="stylesheet" type="text/css">
<script type="text/javascript"
	src="<%=request.getContextPath()%>/activetin/js/jquery-2.1.1.min.js"></script>
</head>
<body>
	<div class="wrapper">
		<!-- begin header -->
		<div id="header">
			<div class="header-left fl">
				<a href="index.html" title=""><img
					src="<%=request.getContextPath()%>/activetin/images/logo_edu.png"
					alt="" /></a>
			</div>
			<div class="header-right fr">
				<a href="index.html" title=""><img
					src="<%=request.getContextPath()%>/activetin/images/banner.jpg"
					alt="" /></a>
			</div>
			<div class="clr"></div>
		</div>
					...
					<table border="1" cellpadding="5" cellspacing="1" width="100%">
						...
						<tr>
							...
							<td><a href="javascript:void(0)" title=""><img
									src="<%=request.getContextPath()%>/activetin/images/active.gif"
									alt="" /></a></td>
						</tr>
						<tr>
							<td>3</td>
							...
							<td><a href="javascript:void(0)" title=""><img
									src="<%=request.getContextPath()%>/activetin/images/deactive.gif"
									alt="" /></a></td>
						</tr>
						<tr>
							<td>4</td>
